...
internal object ContentFileParser {
    ...
    private fun readStickerPack(reader: JsonReader): StickerPack {
        ...
        reader.endObject()
        val stickerPack = StickerPack(identifier, name, publisher, trayImageFile, publisherEmail, publisherWebsite, privacyPolicyWebsite, licenseAgreementWebsite, imageDataVersion, avoidCache, animatedStickerPack)
