...
class StickerPackInfoActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val trayIconUriString = intent.getStringExtra(StickerPackDetailsActivity.Companion.EXTRA_STICKER_PACK_TRAY_ICON)
        val website = intent.getStringExtra(StickerPackDetailsActivity.Companion.EXTRA_STICKER_PACK_WEBSITE)
        val email = intent.getStringExtra(StickerPackDetailsActivity.Companion.EXTRA_STICKER_PACK_EMAIL)
        val privacyPolicy = intent.getStringExtra(StickerPackDetailsActivity.Companion.EXTRA_STICKER_PACK_PRIVACY_POLICY)
        val licenseAgreement = intent.getStringExtra(StickerPackDetailsActivity.Companion.EXTRA_STICKER_PACK_LICENSE_AGREEMENT)
